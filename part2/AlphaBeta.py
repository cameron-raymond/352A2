...
class AlphaBeta:
    ...
    def __init__(self, game_tree,graphID=None):
        ...
        print('Finished - Score:{:d}, Leaf Nodes Examined: {:d}, Total Time: {:f}\n'.format(int(self.score),int(self.numLeavesExamined),time.time()-start))
        return
...
if __name__ == "__main__":
    ...
    for i, tree in enumerate(trees):
        ...
        with open(outfile, 'a') as f:
            f.write("Graph: {}, Score: {}, Leaf nodes examined: {}\n".format(i+1, alpha_beta.score, alpha_beta.numLeavesExamined))
